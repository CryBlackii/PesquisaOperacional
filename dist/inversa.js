...
exports.criarMatrizIdentidade = criarMatrizIdentidade;
exports.criarMatrizInversa = criarMatrizInversa;
/**
...
function criarMatrizIdentidade(matrizQuadrada) {
    ...
    const identidade = Array.from({ length: tamanho }, () => Array(tamanho).fill(0));
